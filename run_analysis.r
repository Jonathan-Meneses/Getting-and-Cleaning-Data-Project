...
test_set          <- read.table("./train/X_train.txt")          #imports the testing set
test_labels       <- read.table("./train/y_train.txt")          #imports the testing label for subjects
subject_test      <- read.table("./train/subject_train.txt")    #labels of which subject the row corresponds to
